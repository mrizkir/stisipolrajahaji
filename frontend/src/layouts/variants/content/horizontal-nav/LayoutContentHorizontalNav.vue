    ...
    <template #footer>
      <div class="d-flex justify-space-between">
        <span
          ...
          <a href="https://stisipolrajahaji.ac.id" class="text-decoration-none">STISIPOL Raja Haji</a>, All rights
          Reserved</span
        >
        <div class="d-flex align-center">
          <span>Dikembangkan Oleh TIM IT STISIPOL Raja Haji dengan </span>
