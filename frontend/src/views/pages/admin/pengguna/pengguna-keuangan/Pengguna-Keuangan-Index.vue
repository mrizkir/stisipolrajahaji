<template>
  <PenggunaSistemLayout>
    ...
    <template v-slot:page-breadcrumb>
      ...
      <b-breadcrumb-item active>Pengguna Keuangan</b-breadcrumb-item>
    </template>
              ...
              <template #header>
                ...
                <div class="card-tools">
                  ...
                  <b-button
                    ...
                    variant="outline-primary"
                    @click.stop="
                      $router.push('/sistem-pengguna/keuangan/create')
                    "
                    v-if="
                      $store.getters['auth/can']('SYSTEM-USERS-KEUANGAN_STORE')
                    "
                    v-b-tooltip.hover
                ...
                >
                  ...
                  <template #cell(aksi)="{ item }">
                    <b-button
                      ...
                      size="xs"
                      :to="
                        '/sistem-pengguna/keuangan/' + item.userid + '/detail'
                      "
                      :disabled="btnLoading"
                      v-if="
                        $store.getters['auth/can']('SYSTEM-USERS-KEUANGAN_SHOW')
                      "
                    >
                    ...
                    <b-button
                      ...
                      size="xs"
                      :to="
                        '/sistem-pengguna/keuangan/' + item.userid + '/edit'
                      "
                      :disabled="btnLoading"
                      v-if="
                        $store.getters['auth/can'](
                          'SYSTEM-USERS-KEUANGAN_UPDATE'
                        )
                      "
                    >
...
<script>
  ...
  export default {
    ...
    methods: {
      updatesettingpage() {
        var page = this.$store.getters['uiadmin/Page']('pengguna-keuangan')
      ...
      handleDelete(event) {
        ...
        this.$ajax
          .post(
            '/system/userskeuangan/' + this.dataItem.userid,
            {
              _method: 'DELETE',
            },
            {
