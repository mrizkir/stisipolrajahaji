              ...
              <template #header>
                ...
                <div class="card-tools">
                  ...
                  <b-button
                    ...
                    variant="outline-primary"
                    @click.stop="
                      $router.push('/sistem-pengguna/superadmin/create')
                    "
                    v-if="
                      $store.getters['auth/can'](
                        'SYSTEM-USERS-SUPERADMIN_STORE'
                      )
                    "
                    v-b-tooltip.hover
                ...
                >
                  ...
                  <template #cell(aksi)="{ item }">
                    <b-button
                      ...
                      size="xs"
                      :to="
                        '/sistem-pengguna/superadmin/' + item.userid + '/detail'
                      "
                      :disabled="btnLoading"
                      v-if="
                        $store.getters['auth/can'](
                          'SYSTEM-USERS-SUPERADMIN_SHOW'
                        )
                      "
                    >
                    ...
                    <b-button
                      ...
                      size="xs"
                      :to="
                        '/sistem-pengguna/superadmin/' + item.userid + '/edit'
                      "
                      :disabled="btnLoading"
                      v-if="
                        $store.getters['auth/can'](
                          'SYSTEM-USERS-SUPERADMIN_UPDATE'
                        )
                      "
                    >
                    ...
                    <b-button
                      ...
                      v-if="
                        $store.getters['auth/can'](
                          'SYSTEM-USERS-SUPERADMIN_DESTROY'
                        )
                      "
                    >
