<template>
  <PenggunaSistemLayout>
    ...
    <template v-slot:page-breadcrumb>
      ...
      <b-breadcrumb-item active>Pengguna Superadmin</b-breadcrumb-item>
    </template>
    <template v-slot:page-content>
      <b-container fluid v-if="$store.getters['auth/can']('SYSTEM-USERS-SUPERADMIN_BROWSE')">
        <b-row>
          <b-col>
            <b-card
              no-body
              ...
              <template #header>
                ...
                <div class="card-tools">
                  ...
                  <b-button
                    size="xs"
                    variant="outline-primary"
                    @click.stop="$router.push('/sistem-pengguna/superadmin/create')"
                    v-if="$store.getters['auth/can']('SYSTEM-USERS-SUPERADMIN_STORE')"
                    v-b-tooltip.hover
                ...
                >
                  ...
                  <template #cell(aksi)="{ item }">
                    <b-button
                      ...
                      size="xs"
                      :to="'/sistem-pengguna/superadmin/' + item.userid + '/detail'"
                      :disabled="btnLoading"
                    ...
                    <b-button
                      ...
                      size="xs"
                      :to="'/sistem-pengguna/superadmin/' + item.userid + '/edit'"
                      :disabled="btnLoading"
                    ...
                    <b-button
                      ...
                      :disabled="btnLoading"
                      v-if="$store.getters['auth/can']('SYSTEM-USERS-SUPERADMIN_DESTROY')"
                    >
...
<script>
  ...
  export default {
    name: 'PenggunaSuperadminIndex',
    created() {
      this.$store.dispatch('uiadmin/addToPages', {
				name: 'pengguna-superadmin',
        loaded: false,
    ...
    methods: {
      updatesettingpage() {
        var page = this.$store.getters['uiadmin/Page']('pengguna-superadmin')
      ...
      async initialize() {
        ...
        var page = this.$store.getters['uiadmin/Page']('pengguna-superadmin')
        var url = '/system/userssuperadmin?page=' + page.currentPage + '&sortby=' + page.sortBy + '&sortdesc=' + page.sortDesc
      ...
      handleDelete(event) {
        ...
        this.$ajax.post(
          '/system/userssuperadmin/' + this.dataItem.userid,
            {
              _method: 'DELETE',
            },
            {
