        ...
        <li class="nav-item dropdown nav-item-dropdown-xl">
          ...
          <div class="dropdown-menu dropdown-menu-right dropdown-scrollable-xl">
            ...
            <div class="dropdown-submenu dropdown-submenu-left">
              ...
              <div class="dropdown-menu">
                <a href="../../../../layout_1/LTR/material/full/index.html" class="dropdown-item">Default layout</a>
                <a href="../../../../layout_2/LTR/material/full/index.html" class="dropdown-item">Layout 2</a>
                <a href="../../../../layout_3/LTR/material/full/index.html" class="dropdown-item">Layout 3</a>
                <a href="../../../../layout_4/LTR/material/full/index.html" class="dropdown-item">Layout 4</a>
                <a href="../../../../layout_5/LTR/material/full/index.html" class="dropdown-item">Layout 5</a>
                <a href="index.html" class="dropdown-item active">Layout 6</a>
                <a href="../../../../layout_7/LTR/material/full/index.html" class="dropdown-item disabled">
                  Layout 7
            ...
            <div class="dropdown-submenu dropdown-submenu-left">
              ...
              <div class="dropdown-menu">
                <a href="../../../LTR/default/full/index.html" class="dropdown-item">Default</a>
                <a href="index.html" class="dropdown-item active">Material</a>
            ...
            <a href="../../../RTL/material/full/index.html" class="dropdown-item">
      ...
      <ul class="navbar-nav flex-row">
        <li class="nav-item">
          <a href="#notifications" class="navbar-nav-link navbar-nav-link-toggler" data-toggle="modal">
            ...
            <span class="badge badge-mark border-yellow bg-yellow"></span>
          </a>
        </li>
        ...
        <div class="page-header">
          <div class="page-header-content container header-elements-md-inline">
            ...
            <div class="header-elements d-none py-0 mb-3 mb-md-0">
              ...
              <button type="button" class="btn btn-dark ml-3"> <i class="icon-file-presentation mr-2"></i> Generate report</button>
            </div>
          </div>
        </div>
        <!-- /page header -->
              ...
              <table class="table text-nowrap">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>June 12th</td>
                    <td><img src="assets/images/brands/ups.svg" class="mr-1" width="20" alt=""> UPS Express</td>
                  ...
                  <tr>
                    ...
                    <td>June 13th</td>
                    <td><img src="assets/images/brands/deutsche-post.svg" class="rounded-sm mr-1" width="20" alt=""> Deutsche post</td>
                  ...
                  <tr>
                    ...
                    <td>June 14th</td>
                    <td><img src="assets/images/brands/postnl.svg" class="mr-1" width="20" alt=""> PostNL</td>
                  ...
                  <tr>
                    ...
                    <td>June 15th</td>
                    <td><img src="assets/images/brands/fedex.svg" class="rounded-sm mr-1" width="20" alt=""> Fedex Express</td>
                    <td><span class="badge badge-success-100 text-success">Delivered</span></td>
                    <td class="text-center">
                      <div class="dropdown">
                        <a href="#" class="btn btn-outline-light btn-icon btn-sm text-body border-transparent rounded-pill" data-toggle="dropdown">
                  ...
                  <tr>
                    ...
                    <td>June 17th</td>
                    <td><img src="assets/images/brands/tnt.svg" class="rounded-sm mr-1" width="20" alt=""> TNT</td>
                    <td><span class="badge badge-indigo-100 text-indigo">Dispatched</span></td>
                    <td class="text-center">
                      <div class="dropdown">
                        <a href="#" class="btn btn-outline-light btn-icon btn-sm text-body border-transparent rounded-pill" data-toggle="dropdown">
                  ...
                  <tr>
                    ...
                    <td>June 18th</td>
                    <td><img src="assets/images/brands/dpd.svg" class="mr-1" width="20" alt=""> DPD</td>
                    <td><span class="badge badge-danger-100 text-danger">Delayed</span></td>
                    <td class="text-center">
                      <div class="dropdown">
                        <a href="#" class="btn btn-outline-light btn-icon btn-sm text-body border-transparent rounded-pill" data-toggle="dropdown">
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <div class="d-flex align-items-center">
                            <img src="assets/images/browsers/chrome.svg" class="mr-2" alt=""
                              style="height: 32px;">
                            Chrome
                          </div>
                        </td>
                      ...
                      <tr>
                        <td>
                          <div class="d-flex align-items-center">
                            <img src="assets/images/browsers/firefox.svg" class="mr-2" alt=""
                              style="height: 32px;">
                            Firefox
                          </div>
                        </td>
                      ...
                      <tr>
                        <td>
                          <div class="d-flex align-items-center">
                            <img src="assets/images/browsers/edge.svg" class="mr-2" alt=""
                              style="height: 32px;">
                            Edge
                          </div>
                        </td>
                      ...
                      <tr>
                        <td>
                          <div class="d-flex align-items-center">
                            <img src="assets/images/browsers/safari.svg" class="mr-2" alt=""
                              style="height: 32px;">
                            Safari
                          </div>
                        </td>
                      ...
                      <tr>
                        <td>
                          <div class="d-flex align-items-center">
                            <img src="assets/images/browsers/opera.svg" class="mr-2" alt=""
                              style="height: 32px;">
                            Opera
                          </div>
                        </td>
...
<style lang="scss">
@import "@/scss/shared/icons/icomoon/compile/styles";
@import "@/scss/layouts/layout_6/material/compile/bootstrap";
@import "@/scss/layouts/layout_6/material/compile/bootstrap_limitless";
@import "@/scss/layouts/layout_6/material/compile/components";
@import "@/scss/layouts/layout_6/material/compile/layout";
</style>