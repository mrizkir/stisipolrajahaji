...
$router->group(['prefix'=>'v2'], function () use ($router)
{
	...
	//kemahasiswaan - data mahasiswa
	$router->get('/kemahasiswaan/{id}/status',['uses'=>'Kemahasiswaan\MahasiswaController@status','as'=>'kemahasiswaan-mhs.status']);
});
...
$router->group(['prefix'=>'v2', 'middleware'=>'auth:api'], function () use ($router)
{
	...
	$router->post('/feeder/perkuliahan/trakm/printtoexcel1',['middleware'=>['role:superadmin|manajemen'],'uses'=>'Feeder\FeederPerkuliahanTRAKMController@printtoexcel1','as'=>'feedertrakm.printtoexcel1']);
	...
	$router->get('/system/userskeuangan/{id}',['middleware'=>['role:superadmin|keuangan'],'uses'=>'System\UsersKeuanganController@show','as'=>'userskeuangan.show']);
...
$router->group(['prefix'=>'v2/h2h/brk', 'middleware'=>'h2hbrk:api'], function () use ($router)
{
	//inquiry tagihan
